      ...
      <div className="max-w-4xl">
        {badge && (
          <motion.div
            ...
            className="inline-flex items-center gap-2 mb-6 px-3.5 py-1.5 text-[11px] font-black tracking-widest uppercase rounded-full bg-indigo-100 border border-indigo-200 text-indigo-700 shadow-sm"
          >
            {badge}
          </motion.div>
        )}

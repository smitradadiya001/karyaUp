...
import { Sparkles, BrainCircuit, Zap, Search, ShieldCheck, Check, X } from "lucide-react";
...
export default function ProfitTracking() {
  ...
  const aiFeatures = [
    { icon: <Sparkles className="w-5 h-5" />, title: "Predictive Margins", desc: "Leverage historical sprint data and current velocity to accurately predict project profitability.", color: "purple" },
    ...
    { icon: <Search className="w-5 h-5" />, title: "Contextual Query", desc: "Ask natural language questions like 'Which project is over budget?' to get instant, deep-dive data visualizations without requiring technical expertise", color: "purple" },
    { icon: <Zap className="w-5 h-5" />, title: "Automated Standups", desc: "Eliminate time-consuming meetings. AI automatically aggregates daily progress, links efforts to budget utilization", color: "fuchsia" },
  ];
  ...
  return (
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="lg:mt-2 text-4xl md:text-[3.25rem] font-black text-slate-900 tracking-tight leading-tight mb-1"
            >
            ...
            <div className="mt-4 space-y-1 max-w-lg w-full">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm sm:text-base text-slate-600 font-medium"> KaryaUp gives you an automated, real time view of <br />your team and project expenses.</p>   
              </div>
            </div>
            ...
            <div className="mt-5 space-y-3 max-w-lg w-full">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm sm:text-base text-slate-600 font-medium">Track profits in real time with complete clarity across every project.</p>   
              </div>
            </div>
          ...
          >
            <div className="relative overflow-hidden  shadow-xl sm:shadow-2xl shadow-slate-900/10 bg-white mt-[-20px] lg:mt-[-5px]">
              <img
                src={dashboardImage}
    ...
    <section className="py-5 bg-white px-4">
      ...
      <section className="py-8 px-6 bg-white-50 relative overflow-hidden border-t border-slate-200">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10 relative z-10">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white text-purple-700 font-bold text-sm mb-6 shadow-sm border border-purple-100"
            >
